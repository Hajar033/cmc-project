...
class Read extends Component
{
    ...
    protected $listeners = ['studentsDeleted'];
    ...
    public function render()
    {
        ...
        $instance = getCrudConfig('students');
        ...
        return view('livewire.admin.students.read', [
            'studentss' => $data
        ])->layout('admin::layouts.app', ['title' => __(\Str::plural('Students')) ]);
    }
}
